...
const checklist = (): Checklist => [
  {
    title: "Computer",
    items: [
      { text: "Use two ground planes in EAGLE. One with the settings width=4, isolate=12. This will make sure the ground plane reaches everywhere. And the other with the settings width=10, isolate=12. The will make sure the ground thermal pads are thick enough." },
      { text: "Export EAGLE files using the CAM processor (disable Cutouts in Profile)." },
      { text: "Generate Flatcam commands using this GUI and paste them into Flatcam." },
      { text: "Wait until Flatcam completes running the commands." },
